...
public class ModelSpiderRobot extends ModelBase
{
    ...
    public void render(final Entity entity, final float f, final float f1, final float f2, final float f3, final float f4, final float f5) {
        ...
        for (int i = 0; i < 8; ++i) {
            ...
            this.Leg1p2.rotationPointX = this.Leg1p1.rotationPointX + (float)Math.cos(this.Leg1p1.rotateAngleX) * (float)Math.sin(this.Leg1p1.rotateAngleY) * 99.0f;
            ...
            this.Leg1p3.rotationPointX = this.Leg1p2.rotationPointX + (float)Math.cos(this.Leg1p2.rotateAngleX) * (float)Math.sin(this.Leg1p2.rotateAngleY) * 99.0f;
