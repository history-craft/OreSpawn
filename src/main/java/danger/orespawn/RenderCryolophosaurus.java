...
public class RenderCryolophosaurus extends RenderLiving
{
    ...
    public void renderCryolophosaurus(final Cryolophosaurus par1EntityCryolophosaurus, final double par2, final double par4, final double par6, final float par8, final float par9) {
