...
public class SeaViper extends EntityMob
{
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(18.0, 4.0, 18.0));
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (SeaViper)this.worldObj.findNearestEntityWithinAABB((Class)SeaViper.class, this.boundingBox.expand(16.0, 5.0, 16.0), (Entity)this);
        return target == null;
    }
