...
public class Elevator extends EntityLiving
{
    ...
    public void onUpdate() {
        ...
        if (this.getExploding() > 0 && this.riddenByEntity != null) {
            ...
            for (int i = 0; i < 15; ++i) {
                this.worldObj.spawnParticle("explode", (double)(int)(this.posX + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 4.0f), (double)(int)(this.posY + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 4.0f), (double)(int)(this.posZ + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 4.0f), this.motionX, 0.0, this.motionZ);
                this.worldObj.spawnParticle("largeexplode", (double)(int)(this.posX + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 2.0f), (double)(int)(this.posY + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 2.0f), (double)(int)(this.posZ + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 2.0f), this.motionX, 0.0, this.motionZ);
                this.worldObj.spawnParticle("smoke", (double)(int)(this.posX + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 5.0f), (double)(int)(this.posY + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 5.0f), (double)(int)(this.posZ + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 5.0f), this.motionX, 0.0, this.motionZ);
                this.worldObj.spawnParticle("largesmoke", (double)(int)(this.posX + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 3.0f), (double)(int)(this.posY + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 3.0f), (double)(int)(this.posZ + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 3.0f), this.motionX, 0.0, this.motionZ);
            }
        }
        if (this.worldObj.isRemote) {
            if (this.riddenByEntity == null) {
            ...
            list = this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.boundingBox.expand(0.25, 0.0, 0.25));
