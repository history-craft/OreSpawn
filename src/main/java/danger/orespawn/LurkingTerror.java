...
public class LurkingTerror extends EntityMob
{
    ...
    public boolean attackEntityAsMob(final Entity par1Entity) {
        final boolean var4 = par1Entity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), 5.0f);
        return var4;
    }
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (LurkingTerror)this.worldObj.findNearestEntityWithinAABB((Class)LurkingTerror.class, this.boundingBox.expand(32.0, 16.0, 32.0), (Entity)this);
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(12.0, 8.0, 12.0));
