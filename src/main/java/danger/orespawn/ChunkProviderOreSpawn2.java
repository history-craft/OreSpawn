...
public class ChunkProviderOreSpawn2 implements IChunkProvider
{
    ...
    public void populate(final IChunkProvider par1IChunkProvider, final int par2, final int par3) {
        ...
        boolean doGen;
        int j2;
        for (doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, PopulateChunkEvent.Populate.EventType.DUNGEON), k2 = 0; doGen && k2 < 8; ++k2) {
            int l2 = k + this.rand.nextInt(16) + 8;
        ...
        k += 8;
        l += 8;
        for (doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, PopulateChunkEvent.Populate.EventType.ICE), k2 = 0; doGen && k2 < 16; ++k2) {
            ...
            if (par1EnumCreatureType == EnumCreatureType.monster) {
                if (this.MyMobList == null) {
                    ...
                    if (OreSpawnMain.AlosaurusEnable != 0) {
                        this.MyMobList.add(new BiomeGenBase.SpawnListEntry((Class)Alosaurus.class, 8, 1, 2));
                    }
                    if (OreSpawnMain.TRexEnable != 0) {
                        this.MyMobList.add(new BiomeGenBase.SpawnListEntry((Class)TRex.class, 6, 1, 2));
                    }
                    if (OreSpawnMain.NastysaurusEnable != 0) {
                        this.MyMobList.add(new BiomeGenBase.SpawnListEntry((Class)Nastysaurus.class, 6, 1, 2));
                    }
                    if (OreSpawnMain.PointysaurusEnable != 0) {
                        this.MyMobList.add(new BiomeGenBase.SpawnListEntry((Class)Pointysaurus.class, 10, 4, 8));
                    }
                    if (OreSpawnMain.GammaMetroidEnable != 0) {
                        this.MyMobList.add(new BiomeGenBase.SpawnListEntry((Class)GammaMetroid.class, 35, 4, 7));
                    }
                    if (OreSpawnMain.AlienEnable != 0) {
                        this.MyMobList.add(new BiomeGenBase.SpawnListEntry((Class)Alien.class, 35, 2, 3));
                    }
                    if (OreSpawnMain.CaveFisherEnable != 0) {
                        this.MyMobList.add(new BiomeGenBase.SpawnListEntry((Class)CaveFisher.class, 35, 4, 8));
                    }
                    if (OreSpawnMain.CryolophosaurusEnable != 0) {
                        this.MyMobList.add(new BiomeGenBase.SpawnListEntry((Class)Cryolophosaurus.class, 26, 4, 7));
                    }
                    if (OreSpawnMain.SpyroEnable != 0) {
                        this.MyMobList.add(new BiomeGenBase.SpawnListEntry((Class)Spyro.class, 5, 1, 2));
                    }
            ...
            if (par1EnumCreatureType == EnumCreatureType.ambient) {
                if (this.MyAmbientList == null) {
                    ...
                    if (OreSpawnMain.VelocityRaptorEnable != 0) {
                        this.MyAmbientList.add(new BiomeGenBase.SpawnListEntry((Class)VelocityRaptor.class, 1, 2, 4));
                    }
                    if (OreSpawnMain.DragonflyEnable != 0) {
                        this.MyAmbientList.add(new BiomeGenBase.SpawnListEntry((Class)Dragonfly.class, 2, 1, 3));
                    }
                    if (OreSpawnMain.CamarasaurusEnable != 0) {
                        this.MyAmbientList.add(new BiomeGenBase.SpawnListEntry((Class)Camarasaurus.class, 1, 2, 4));
                    }
                    if (OreSpawnMain.BaryonyxEnable != 0) {
                        this.MyAmbientList.add(new BiomeGenBase.SpawnListEntry((Class)Baryonyx.class, 2, 4, 8));
                    }
                    for (final Object var7 : l) {
