...
public class RenderHerculesBeetle extends RenderLiving
{
    ...
    public void renderHerculesBeetle(final HerculesBeetle par1EntityHerculesBeetle, final double par2, final double par4, final double par6, final float par8, final float par9) {
