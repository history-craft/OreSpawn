...
public class Mothra extends EntityButterfly implements IMob
{
    ...
    protected void updateAITasks() {
        ...
        if (this.stuck_count > 50 || this.worldObj.rand.nextInt(300) == 0 || this.currentFlightTarget.getDistanceSquared((int)this.posX, (int)this.posY, (int)this.posZ) < 9.0f) {
            ...
            target = (EntityPlayer)this.worldObj.findNearestEntityWithinAABB((Class)EntityPlayer.class, this.boundingBox.expand(25.0, 20.0, 25.0), (Entity)this);
            if (target != null) {
    ...
    public boolean getCanSpawnHere() {
        ...
        Mothra target = null;
        target = (Mothra)this.worldObj.findNearestEntityWithinAABB((Class)Mothra.class, this.boundingBox.expand(64.0, 32.0, 64.0), (Entity)this);
        return target == null;
    }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(15.0, 20.0, 15.0));
