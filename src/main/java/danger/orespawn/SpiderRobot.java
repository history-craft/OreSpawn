...
public class SpiderRobot extends EntityLiving
{
    ...
    public SpiderRobot(final World par1World) {
        ...
        this.tasks.addTask(0, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, (Class)EntityPlayer.class, 12.0f));
    ...
    public void onUpdate() {
        ...
        if (this.worldObj.rand.nextInt(8) == 0) {
            this.worldObj.spawnParticle("flame", this.posX + dx, this.posY + 2.0, this.posZ + dz, (double)(dx / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0f), (double)((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 10.0f), (double)(dz / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0f));
        }
        if (this.worldObj.rand.nextInt(2) == 0) {
            this.worldObj.spawnParticle("smoke", this.posX + dx, this.posY + 2.0, this.posZ + dz, (double)(dx / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0f), (double)((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 10.0f), (double)(dz / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0f));
        }
        if (this.worldObj.rand.nextInt(10) == 0) {
            this.worldObj.spawnParticle("fireworksSpark", this.posX + dx, this.posY + 2.0, this.posZ + dz, (double)(dx / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0f), (double)((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 5.0f), (double)(dz / f + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 20.0f));
        }
    }
    ...
    private void feetFindSomethingToHit() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(20.0, 8.0, 20.0));
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(20.0, 12.0, 20.0));
        final Iterator var6 = var5.iterator();
        Entity var7 = null;
        EntityLivingBase var8 = null;
        while (var6.hasNext()) {
