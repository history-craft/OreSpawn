...
public class MyEntityAIFollowOwner extends EntityAIBase
{
    ...
    public boolean shouldExecute() {
        ...
        this.theOwner = var1;
        return !this.thePet.isSitting() && (!(this.thePet instanceof Girlfriend) || OreSpawnMain.valentines_day == 0) && ((this.thePet != null && (this.thePet.posY < 60.0 || !this.thePet.worldObj.isDaytime()) && this.thePet.getDistanceSqToEntity((Entity)var1) > this.maxDist / 2.0f * (this.maxDist / 2.0f)) || this.thePet.getDistanceSqToEntity((Entity)var1) >= this.maxDist * this.maxDist);
    }
