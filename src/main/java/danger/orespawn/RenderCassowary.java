...
public class RenderCassowary extends RenderLiving
{
    ...
    public void renderCassowary(final Cassowary par1EntityCassowary, final double par2, final double par4, final double par6, final float par8, final float par9) {
