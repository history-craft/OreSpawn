...
public class TheKing extends EntityMob
{
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ...
        while (j < 150) {
            int k;
            for (k = 1 + this.worldObj.rand.nextInt(icount), ilist = Item.itemRegistry.iterator(); k > 0 && ilist.hasNext(); --k) {
                it = (Item) ilist.next();
            }
            if (it != null) {
                ++j;
        ...
        while (j < 150) {
            int k;
            for (k = 1 + this.worldObj.rand.nextInt(bcount), blist = Block.blockRegistry.iterator(); k > 0 && blist.hasNext(); --k) {
                bl = (Block) blist.next();
            }
            if (bl != null) {
                ++j;
    ...
    public boolean attackEntityAsMob(final Entity par1Entity) {
        if (par1Entity != null && par1Entity instanceof EntityLivingBase) {
            ...
            if (s > 30.0f && !MyUtils.isRoyalty(par1Entity) && !(par1Entity instanceof Godzilla) && !(par1Entity instanceof GodzillaHead) && !(par1Entity instanceof PitchBlack) && !(par1Entity instanceof Kraken)) {
                ...
                e.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), (float)this.attdam * 10.0f);
        ...
        final boolean var22 = par1Entity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), (float)this.attdam);
        if (var22) {
            final double ks = 3.3;
            double inair = 0.25;
    ...
    private void msgToPlayers(final String s) {
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityPlayer.class, this.boundingBox.expand(80.0, 64.0, 80.0));
        ...
        while (var6.hasNext()) {
            ...
            var8.addChatComponentMessage((IChatComponent)new ChatComponentText(s));
        }
    }
        ...
        if (this.isEnd != 1) {
            ...
            if (this.tooFarFromHome() || this.worldObj.rand.nextInt(200) == 0 || this.currentFlightTarget.getDistanceSquared((int)this.posX, (int)this.posY, (int)this.posZ) < 9.1f) {
                ...
                if (this.head_found == 0) {
                    final EntityLiving entityLiving = (EntityLiving)spawnCreature(this.worldObj, "KingHead", this.posX, this.posY + 20.0, this.posZ);
                }
                if (e == null) {
                    e = f;
                }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        if (this.isEnd == 2) {
            final List var5p = this.worldObj.getEntitiesWithinAABB((Class)EntityPlayer.class, this.boundingBox.expand(80.0, 64.0, 80.0));
            ...
            this.head_found = 1;
            while (var2p.hasNext()) {
                var4p = (EntityLivingBase)var2p.next();
                if (this.isSuitableTarget(var4p, false)) {
                    return var4p;
                }
            }
        }
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(80.0, 64.0, 80.0));
        Collections.sort((List<Object>)var5, this.TargetSorter);
        final Iterator var6 = var5.iterator();
        Entity var7 = null;
    ...
    private EntityLivingBase doJumpDamage(final double X, final double Y, final double Z, final double dist, final double damage, final int knock) {
        ...
        while (var6.hasNext()) {
            ...
            this.worldObj.playSoundAtEntity((Entity)var8, "random.explode", 0.65f, 1.0f + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.5f);
            if (knock == 0) {
                continue;
            }
