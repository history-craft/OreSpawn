...
public class UltimateHoe extends ItemHoe
{
    ...
    public boolean onItemUse(final ItemStack par1ItemStack, final EntityPlayer par2EntityPlayer, final World par3World, final int par4, final int par5, final int par6, final int par7, final float par8, final float par9, final float par10) {
        ...
        par3World.playSoundEffect((double)(par4 + 0.5f), (double)(par5 + 0.5f), (double)(par6 + 0.5f), block.stepSound.getBreakSound(), (block.stepSound.getVolume() + 1.0f) / 2.0f, block.stepSound.getPitch() * 0.8f);
