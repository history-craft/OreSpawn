...
public class ExperienceCatcher extends Item
{
    ...
    public boolean onItemUse(final ItemStack par1ItemStack, final EntityPlayer par2EntityPlayer, final World world, final int x, final int y, final int z, final int par7, final float par8, final float par9, final float par10) {
        ...
        if (!par2EntityPlayer.worldObj.isRemote) {
            final AxisAlignedBB bb = AxisAlignedBB.getBoundingBox(x - 0.5 + par8, (double)y, z - 0.5 + par10, x + 0.5 + par8, y + 2.0, z + 0.5 + par10);
            final List<Entity> var5 = world.getEntitiesWithinAABB((Class)EntityXPOrb.class, bb);
            for (final Object obj7 : var5) {
                if (obj7 instanceof EntityXPOrb) {
                    Entity var7 = (Entity)obj7;
                    ...
                    var8 = new EntityItem(par2EntityPlayer.worldObj, (double)(par8 + x), y + 1.0, (double)(par10 + z), is);
                    if (var8 != null) {
                        par2EntityPlayer.worldObj.spawnEntityInWorld((Entity)var8);
                    }
            ...
            var9 = new EntityItem(par2EntityPlayer.worldObj, (double)(par8 + x), y + 1.0, (double)(par10 + z), is2);
            if (var9 != null) {
                par2EntityPlayer.worldObj.spawnEntityInWorld((Entity)var9);
            }
            --par1ItemStack.stackSize;
        }
        return true;
