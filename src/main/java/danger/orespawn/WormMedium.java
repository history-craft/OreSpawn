...
public class WormMedium extends EntityMob
{
    ...
    public void onLivingUpdate() {
        ...
        worms = (WormSmall)this.worldObj.findNearestEntityWithinAABB((Class)WormSmall.class, this.boundingBox.expand(8.0, 8.0, 8.0), (Entity)this);
        if (worms == null) {
    ...
    protected void updateAITasks() {
        ...
        target = (EntityPlayer)this.worldObj.findNearestEntityWithinAABB((Class)EntityPlayer.class, this.boundingBox.expand(2.25, 8.0, 2.25), (Entity)this);
    ...
    private void dropItemRand(final Item index, final int par1) {
        final EntityItem var3 = new EntityItem(this.worldObj, this.posX + OreSpawnMain.OreSpawnRand.nextInt(3) - OreSpawnMain.OreSpawnRand.nextInt(3), this.posY + 2.5 + this.worldObj.rand.nextInt(3), this.posZ + OreSpawnMain.OreSpawnRand.nextInt(3) - OreSpawnMain.OreSpawnRand.nextInt(3), new ItemStack(index, par1, 0));
        this.worldObj.spawnEntityInWorld((Entity)var3);
    }
