...
public class ThePrincess extends EntityTameable
{
    ...
    public ThePrincess(final World par1World) {
        ...
        this.tasks.addTask(4, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, (Class)EntityLiving.class, 6.0f));
    ...
    public boolean interact(final EntityPlayer par1EntityPlayer) {
        ...
        if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.diamond_block) && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 16.0) {
