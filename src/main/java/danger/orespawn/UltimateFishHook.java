...
public class UltimateFishHook extends EntityFishHook
{
    ...
    public void onUpdate() {
        if (this.field_146055_aB > 0) {
            ...
            if (!this.field_146051_au) {
                ...
                double d13 = 0.0;
                for (int j = 0; j < b0; ++j) {
                    final double d14 = this.boundingBox.minY + (this.boundingBox.maxY - this.boundingBox.minY) * (j + 0) / b0 - 0.125 + 0.125;
                ...
                if (!this.worldObj.isRemote && d13 > 0.0) {
                    ...
                    if (this.fish_on_hook > 0) {
                        ...
                        if (this.ticks_catchable <= 0) {
                            ...
                            worldserver.func_147487_a("bubble", this.posX, (double)(f4 + 1.0f), this.posZ, (int)(1.0f + this.width * 20.0f), (double)this.width, 0.0, (double)this.width, 0.20000000298023224);
                            worldserver.func_147487_a("wake", this.posX, (double)(f4 + 1.0f), this.posZ, (int)(1.0f + this.width * 20.0f), (double)this.width, 0.0, (double)this.width, 0.20000000298023224);
    ...
    public void writeEntityToNBT(final NBTTagCompound par1NBTTagCompound) {
        ...
        par1NBTTagCompound.setByte("inGround", (byte)(byte)(this.field_146051_au ? 1 : 0));
    }
    ...
    private ItemStack func_146033_f() {
        ...
        if (this.handleLavaMovement() || bid == Blocks.lava || bid == Blocks.flowing_lava) {
            ...
            return ((WeightedRandomFishable)WeightedRandom.getRandomItem(this.rand, (Collection)UltimateFishHook.orespawn_lava_fish)).func_150708_a(this.rand);
        }
        if (f < f2) {
            this.field_146042_b.addStat(StatList.field_151183_A, 1);
            return ((WeightedRandomFishable)WeightedRandom.getRandomItem(this.rand, (Collection)UltimateFishHook.field_146039_d)).func_150708_a(this.rand);
        }
        f -= f2;
        if (f < f3) {
            this.field_146042_b.addStat(StatList.field_151184_B, 1);
            return ((WeightedRandomFishable)WeightedRandom.getRandomItem(this.rand, (Collection)UltimateFishHook.field_146041_e)).func_150708_a(this.rand);
        }
        final float f4 = this.worldObj.rand.nextFloat();
        this.field_146042_b.addStat(StatList.fishCaughtStat, 1);
        if (f4 < 0.5f) {
            return ((WeightedRandomFishable)WeightedRandom.getRandomItem(this.rand, (Collection)UltimateFishHook.field_146036_f)).func_150708_a(this.rand);
        }
        return ((WeightedRandomFishable)WeightedRandom.getRandomItem(this.rand, (Collection)UltimateFishHook.orespawn_fish)).func_150708_a(this.rand);
    }
