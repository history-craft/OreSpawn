...
public class MyEntityAIDance extends EntityAIBase
{
    ...
    public void updateTask() {
        ...
        final AxisAlignedBB bb = AxisAlignedBB.getBoundingBox(this.thePet.posX - 4.0, this.thePet.posY - 3.0, this.thePet.posZ - 4.0, this.thePet.posX + 4.0, this.thePet.posY + 3.0, this.thePet.posZ + 4.0);
        final List<Girlfriend> var5 = this.theWorld.getEntitiesWithinAABB(Girlfriend.class, bb);
