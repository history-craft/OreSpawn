...
public class Vortex extends EntityMob
{
        ...
        if (e != null) {
            ...
            if (this.worldObj.isRemote) {
                for (int i = 0; i < 20; ++i) {
                    ...
                    this.worldObj.spawnParticle("smoke", this.posX + dx, this.posY + 0.75 + d, this.posZ + dz, Math.cos(dir) * this.worldObj.rand.nextFloat() / 4.0, (double)(this.worldObj.rand.nextFloat() / 2.0f), Math.sin(dir) * this.worldObj.rand.nextFloat() / 4.0);
                }
            }
        }
    ...
    protected void updateAITasks() {
        ...
        if (e != null) {
            ...
            if (this.getDistanceSqToEntity((Entity)e) < (4.0f + e.width / 2.0f) * (4.0f + e.width / 2.0f) && this.rand.nextInt(8) == 2) {
    ...
    public boolean getCanSpawnHere() {
        ...
        Vortex target = null;
        target = (Vortex)this.worldObj.findNearestEntityWithinAABB((Class)Vortex.class, this.boundingBox.expand(20.0, 16.0, 20.0), (Entity)this);
        return target == null;
    }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(16.0, 10.0, 16.0));
