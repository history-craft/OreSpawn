...
public class CreeperRepellent extends BlockTorch
{
    ...
    private void findSomethingToRepell(final World par1World, final int par2, final int par3, final int par4) {
        final AxisAlignedBB bb = AxisAlignedBB.getBoundingBox(par2 - 20.0, par3 - 10.0, par4 - 20.0, par2 + 20.0, par3 + 10.0, par4 + 20.0);
        final List var5 = par1World.getEntitiesWithinAABB((Class)EntityLivingBase.class, bb);
