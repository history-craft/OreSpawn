...
public class RenderCephadrome extends RenderLiving
{
    ...
    public void renderCephadrome(final Cephadrome par1EntityCephadrome, final double par2, final double par4, final double par6, final float par8, final float par9) {
