...
public class EmperorScorpion extends EntityMob
{
        ...
        if (this.worldObj.rand.nextInt(4) == 0) {
            ...
            if (e != null) {
                ...
                if (this.worldObj.rand.nextInt(20) == 1) {
                    final EntityCreature newent = (EntityCreature)spawnCreature(this.worldObj, "Scorpion", (this.posX + e.posX) / 2.0 + this.worldObj.rand.nextInt(5) - this.worldObj.rand.nextInt(5), (this.posY + e.posY) / 2.0 + 1.01, (this.posZ + e.posZ) / 2.0 + this.worldObj.rand.nextInt(5) - this.worldObj.rand.nextInt(5));
                }
            }
            else {
                this.setAttacking(0);
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(24.0, 6.0, 24.0));
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (EmperorScorpion)this.worldObj.findNearestEntityWithinAABB((Class)EmperorScorpion.class, this.boundingBox.expand(20.0, 6.0, 20.0), (Entity)this);
        return target == null;
    }
}
