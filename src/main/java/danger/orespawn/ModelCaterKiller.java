...
public class ModelCaterKiller extends ModelBase
{
    ...
    public void render(final Entity entity, final float f, final float f1, final float f2, final float f3, final float f4, final float f5) {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            newangle = MathHelper.cos((float)(f2 * 0.91f * this.wingspeed + 0.39269908169872414 * i)) * 3.1415927f * 0.08f;
            this.seg1lspike.rotateAngleZ = newangle;
            this.seg1rspike.rotateAngleZ = -newangle;
            if (e.getAttacking() != 0) {
                newangle = MathHelper.cos((float)(f2 * 2.91f * this.wingspeed + 0.39269908169872414 * i)) * 3.1415927f * 0.15f;
            }
            else {
                newangle = MathHelper.cos((float)(f2 * 0.35f * this.wingspeed + 0.39269908169872414 * i)) * 3.1415927f * 0.04f;
            }
