...
public class CloudShark extends EntityMob
{
    ...
    public boolean attackEntityAsMob(final Entity par1Entity) {
        ...
        final boolean flag = par1Entity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), f);
        return flag;
    }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(12.0, 10.0, 12.0));
