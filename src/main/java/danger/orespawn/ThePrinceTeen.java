...
public class ThePrinceTeen extends EntityTameable
{
    ...
    public ThePrinceTeen(final World par1World) {
        ...
        this.tasks.addTask(4, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, (Class)EntityLiving.class, 9.0f));
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(25.0, 20.0, 25.0));
        ...
        if (this.worldObj.isRemote) {
            ...
            if (this.getActivity() != 0) {
                ...
                if (this.riddenByEntity != null) {
                    ...
                    this.motionZ *= 0.985;
                    if (!this.worldObj.isRemote) {
                        list = this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.boundingBox.expand(3.25, 4.0, 3.25));
    ...
    public boolean interact(final EntityPlayer par1EntityPlayer) {
        ...
        if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.diamond_block) && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 25.0) {
            if (!this.worldObj.isRemote) {
                this.setTamed(true);
        ...
        if (this.isTamed()) {
            ...
            if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.ice) && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 25.0) {
                if (!this.worldObj.isRemote) {
                    this.playTameEffect(true);
