...
public class WormLarge extends EntityMob
{
    ...
    public void onLivingUpdate() {
        ...
        worms = (WormMedium)this.worldObj.findNearestEntityWithinAABB((Class)WormMedium.class, this.boundingBox.expand(8.0, 8.0, 8.0), (Entity)this);
        if (worms == null) {
            target = (EntityPlayer)this.worldObj.findNearestEntityWithinAABB((Class)EntityPlayer.class, this.boundingBox.expand(8.0, 8.0, 8.0), (Entity)this);
        }
    ...
    protected void updateAITasks() {
        ...
        target = (EntityPlayer)this.worldObj.findNearestEntityWithinAABB((Class)EntityPlayer.class, this.boundingBox.expand(8.0, 6.0, 8.0), (Entity)this);
        ...
        if (target != null) {
            ...
            if (this.worldObj.rand.nextInt(10) == 1 && this.getDistanceToEntity((Entity)target) < 3.0) {
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (WormLarge)this.worldObj.findNearestEntityWithinAABB((Class)WormLarge.class, this.boundingBox.expand(32.0, 8.0, 32.0), (Entity)this);
        if (target != null) {
            return false;
        }
        for (int i = -6; i <= 6; ++i) {
    ...
    private void dropItemRand(final Item index, final int par1) {
        final EntityItem var3 = new EntityItem(this.worldObj, this.posX + OreSpawnMain.OreSpawnRand.nextInt(4) - OreSpawnMain.OreSpawnRand.nextInt(4), this.posY + 2.5 + this.worldObj.rand.nextInt(4), this.posZ + OreSpawnMain.OreSpawnRand.nextInt(4) - OreSpawnMain.OreSpawnRand.nextInt(4), new ItemStack(index, par1, 0));
        this.worldObj.spawnEntityInWorld((Entity)var3);
    }
