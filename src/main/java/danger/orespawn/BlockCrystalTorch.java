...
public class BlockCrystalTorch extends BlockTorch
{
    ...
    public void randomDisplayTick(final World par1World, final int par2, final int par3, final int par4, final Random par5Random) {
        ...
        if (var6 == 1) {
            par1World.spawnParticle("fireworksSpark", var7 - var11, var8 + var10, var9, (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 8.0f), (double)(par1World.rand.nextFloat() / 8.0f), (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 8.0f));
            par1World.spawnParticle("flame", var7 - var11, var8 + var10, var9, (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 60.0f), (double)(par1World.rand.nextFloat() / 10.0f), (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 60.0f));
        }
        else if (var6 == 2) {
            par1World.spawnParticle("fireworksSpark", var7 + var11, var8 + var10, var9, (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 8.0f), (double)(par1World.rand.nextFloat() / 8.0f), (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 8.0f));
            par1World.spawnParticle("flame", var7 + var11, var8 + var10, var9, (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 60.0f), (double)(par1World.rand.nextFloat() / 10.0f), (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 60.0f));
            ...
            par1World.spawnParticle("fireworksSpark", var7, var8 + var10, var9 - var11, (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 8.0f), (double)(par1World.rand.nextFloat() / 8.0f), (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 8.0f));
            par1World.spawnParticle("flame", var7, var8 + var10, var9 - var11, (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 60.0f), (double)(par1World.rand.nextFloat() / 10.0f), (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 60.0f));
        }
        else if (var6 == 4) {
            par1World.spawnParticle("fireworksSpark", var7, var8 + var10, var9 + var11, (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 8.0f), (double)(par1World.rand.nextFloat() / 8.0f), (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 8.0f));
            par1World.spawnParticle("flame", var7, var8 + var10, var9 + var11, (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 60.0f), (double)(par1World.rand.nextFloat() / 10.0f), (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 60.0f));
            ...
            par1World.spawnParticle("fireworksSpark", var7, var8, var9, (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 8.0f), (double)(par1World.rand.nextFloat() / 8.0f), (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 8.0f));
            par1World.spawnParticle("flame", var7, var8, var9, (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 60.0f), (double)(par1World.rand.nextFloat() / 10.0f), (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 60.0f));
        }
    }
    ...
    private boolean canPlaceTorchOn(final World par1World, final int par2, final int par3, final int par4) {
        final Block l = par1World.getBlock(par2, par3, par4);
        return this.isCrystalBlock(par1World, par2, par3, par4) || World.doesBlockHaveSolidTopSurface((IBlockAccess)par1World, par2, par3, par4) || (l != null && l.canPlaceTorchOnTop(par1World, par2, par3, par4));
    }
