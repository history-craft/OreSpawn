...
public class Cephadrome extends EntityCreature
{
    ...
    public Cephadrome(final World par1World) {
        ...
        this.tasks.addTask(2, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, (Class)EntityPlayer.class, 9.0f));
    ...
    public void updateAITasks() {
        ...
        if (this.worldObj.rand.nextInt(7) == 1 && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL) {
            ...
            if (e != null) {
                ...
                this.setAttacking(1);
                if (this.getDistanceSqToEntity((Entity)e) < (maxdist + e.width / 2.0f) * (maxdist + e.width / 2.0f)) {
                    this.attackEntityAsMob((Entity)e);
                }
                else if (e instanceof Kraken && this.getHorizontalDistanceSqToEntity((Entity)e) < (maxdist + e.width / 2.0f) * (maxdist + e.width / 2.0f)) {
                    this.attackEntityAsMob((Entity)e);
                }
            }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(16.0, 20.0, 16.0));
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (Cephadrome)this.worldObj.findNearestEntityWithinAABB((Class)Cephadrome.class, this.boundingBox.expand(16.0, 6.0, 16.0), (Entity)this);
        return target == null;
    }
