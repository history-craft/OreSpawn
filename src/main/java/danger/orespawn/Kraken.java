...
public class Kraken extends EntityMob
{
        ...
        if (this.newtarget != 0 || this.rand.nextInt(250) == 1 || this.currentFlightTarget.getDistanceSquared((int)this.posX, (int)this.posY, (int)this.posZ) < 9.1f) {
            ...
            if (this.long_enough <= 0 || (this.posY < 200.0 && this.getHealth() < this.mygetMaxHealth() / 4)) {
                ...
                if (this.hit_by_player && this.call_reinforcements == 0 && this.getHealth() < this.mygetMaxHealth() / 8 && this.posY > 130.0) {
                    ...
                    for (int i = 0; i < 10; ++i) {
                        final EntityCreature newent = (EntityCreature)spawnCreature(this.worldObj, "The Kraken", this.posX + this.worldObj.rand.nextInt(10) - this.worldObj.rand.nextInt(10), 170.0, this.posZ + this.worldObj.rand.nextInt(10) - this.worldObj.rand.nextInt(10));
                    }
                }
            }
        }
            ...
            target = (EntityPlayer)this.worldObj.findNearestEntityWithinAABB((Class)EntityPlayer.class, this.boundingBox.expand(25.0, 40.0, 25.0), (Entity)this);
            if (target != null) {
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(20.0, 40.0, 20.0));
    ...
    public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
        ...
        boolean ret = false;
        if (this.currentFlightTarget != null && e != null && e instanceof EntityPlayer && this.getHealth() > this.mygetMaxHealth() / 4) {
