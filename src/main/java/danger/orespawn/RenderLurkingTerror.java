...
public class RenderLurkingTerror extends RenderLiving
{
    ...
    public void renderLurkingTerror(final LurkingTerror par1EntityLurkingTerror, final double par2, final double par4, final double par6, final float par8, final float par9) {
