...
public class ChunkProviderOreSpawn5 implements IChunkProvider
{
    ...
    private final void MygenBiomeTerrain(final World p_150560_1_, final Random p_150560_2_, final Block[] p_150560_3_, final byte[] p_150560_4_, final int p_150560_5_, final int p_150560_6_, final double p_150560_7_) {
    ...
    public void addPinkTourmaline(final World world, final Random random, final int chunkX, final int chunkZ, final Chunk chunk) {
    ...
    public void addTigersEye(final World world, final Random random, final int chunkX, final int chunkZ, final Chunk chunk) {
        if (random.nextInt(30) != 1) {
            return;
        }
        final int randPosX = 3 + chunkX + random.nextInt(10);
    ...
    public boolean generateOre(final World par1World, final Random par2Random, final int par3, final int par4, final int par5, final Chunk chunk, final Block newbid, final int numberOfBlocks, final Block oldbid) {
    ...
    public void addQuinoa(final World world, final Random random, final int chunkX, final int chunkZ, final Chunk chunk) {
        if (random.nextInt(20) != 0) {
            return;
        }
        for (int i = 0; i < 5; ++i) {
    ...
    public void addCrystalFlowers(final World world, final Random random, final int chunkX, final int chunkZ, final Chunk chunk) {
