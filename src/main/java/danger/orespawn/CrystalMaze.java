...
public class CrystalMaze
{
    ...
    private void openCrystalMaze(final World world, final int xx, final int yy, final int zz, final int xw, final int zw, final int csz, final Chunk chunk) {
    ...
    private void makeMaze(final World world, final int xx, final int yy, final int zz, final int xw, final int zw, final int csz, final int b, final Chunk chunk) {
        final int gridw = xw;
        final int gridh = zw;
        int cellsize = csz;
        if (cellsize < 3) {
    ...
    private void drawSide(final World world, int fromx, int fromz, int tox, int toz, final int x, final int y, final int z, final int cellsize, final int gridh, final int gridw, final int bb, final Chunk chunk) {
