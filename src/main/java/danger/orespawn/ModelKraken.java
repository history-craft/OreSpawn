...
public class ModelKraken extends ModelBase
{
    ...
    private void dangle_tentacle(final float f2, final int dir, final int att, final ModelRenderer p1, final ModelRenderer p2, final ModelRenderer p3, final ModelRenderer p4, final ModelRenderer p5, final ModelRenderer p6, final ModelRenderer p7, final ModelRenderer p8) {
        ...
        p2.rotationPointY = p1.rotationPointY + (float)Math.sin(p1.rotateAngleX) * dist * (float)Math.cos(p1.rotateAngleY);
        p2.rotationPointZ = p1.rotationPointZ - (float)Math.cos(p1.rotateAngleX) * dist * (float)Math.cos(p1.rotateAngleY);
        p2.rotationPointX = p1.rotationPointX - (float)Math.sin(p1.rotateAngleY) * dist * (float)Math.cos(p1.rotateAngleX);
        ...
        p3.rotationPointY = p2.rotationPointY + (float)Math.sin(p2.rotateAngleX) * dist * (float)Math.cos(p2.rotateAngleY);
        p3.rotationPointZ = p2.rotationPointZ - (float)Math.cos(p2.rotateAngleX) * dist * (float)Math.cos(p2.rotateAngleY);
        p3.rotationPointX = p2.rotationPointX - (float)Math.sin(p2.rotateAngleY) * dist * (float)Math.cos(p2.rotateAngleX);
        ...
        p4.rotationPointY = p3.rotationPointY + (float)Math.sin(p3.rotateAngleX) * dist * (float)Math.cos(p3.rotateAngleY);
        p4.rotationPointZ = p3.rotationPointZ - (float)Math.cos(p3.rotateAngleX) * dist * (float)Math.cos(p3.rotateAngleY);
        p4.rotationPointX = p3.rotationPointX - (float)Math.sin(p3.rotateAngleY) * dist * (float)Math.cos(p3.rotateAngleX);
        ...
        p5.rotationPointY = p4.rotationPointY + (float)Math.sin(p4.rotateAngleX) * dist * (float)Math.cos(p4.rotateAngleY);
        p5.rotationPointZ = p4.rotationPointZ - (float)Math.cos(p4.rotateAngleX) * dist * (float)Math.cos(p4.rotateAngleY);
        p5.rotationPointX = p4.rotationPointX - (float)Math.sin(p4.rotateAngleY) * dist * (float)Math.cos(p4.rotateAngleX);
        ...
        p6.rotationPointY = p5.rotationPointY + (float)Math.sin(p5.rotateAngleX) * dist * (float)Math.cos(p5.rotateAngleY);
        p6.rotationPointZ = p5.rotationPointZ - (float)Math.cos(p5.rotateAngleX) * dist * (float)Math.cos(p5.rotateAngleY);
        p6.rotationPointX = p5.rotationPointX - (float)Math.sin(p5.rotateAngleY) * dist * (float)Math.cos(p5.rotateAngleX);
        ...
        p7.rotationPointY = p6.rotationPointY + (float)Math.sin(p6.rotateAngleX) * dist * (float)Math.cos(p6.rotateAngleY);
        p7.rotationPointZ = p6.rotationPointZ - (float)Math.cos(p6.rotateAngleX) * dist * (float)Math.cos(p6.rotateAngleY);
        p7.rotationPointX = p6.rotationPointX - (float)Math.sin(p6.rotateAngleY) * dist * (float)Math.cos(p6.rotateAngleX);
        ...
        p8.rotationPointY = p7.rotationPointY + (float)Math.sin(p7.rotateAngleX) * dist * (float)Math.cos(p7.rotateAngleY);
        p8.rotationPointZ = p7.rotationPointZ - (float)Math.cos(p7.rotateAngleX) * dist * (float)Math.cos(p7.rotateAngleY);
        p8.rotationPointX = p7.rotationPointX - (float)Math.sin(p7.rotateAngleY) * dist * (float)Math.cos(p7.rotateAngleX);
