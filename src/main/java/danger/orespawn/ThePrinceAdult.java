...
public class ThePrinceAdult extends EntityTameable
{
    ...
    public ThePrinceAdult(final World par1World) {
        ...
        this.tasks.addTask(4, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, (Class)EntityLiving.class, 20.0f));
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(32.0, 20.0, 32.0));
    ...
    private void fly_without_rider() {
        ...
        if (toofar == 0 && this.flyaway == 0 && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL && this.worldObj.rand.nextInt(6) == 1) {
        ...
        if (this.owner_flying != 0) {
            ...
            if (this.isTamed() && this.getOwner() != null) {
                e = this.getOwner();
                if (this.getDistanceSqToEntity((Entity)e) > 64.0) {
                    speed_factor = 3.5;
                }
            }
        }
                ...
                if (this.riddenByEntity != null) {
                    ...
                    if (this.fireballticker == 0 && (pp.moveStrafing < -0.001f || pp.moveStrafing > 0.001f)) {
                        ...
                        if (this.which_attack == 0) {
                            ...
                            final BetterFireball bf = new BetterFireball(this.worldObj, (EntityLivingBase)this, 0.0, 0.0, 0.0);
                            bf.setBig();
                            bf.setNotMe();
                        ...
                        if (this.which_attack == 2) {
                            ...
                            final ThunderBolt lb = new ThunderBolt(this.worldObj, (EntityLivingBase)pp);
                    ...
                    this.motionZ *= 0.985;
                    if (!this.worldObj.isRemote) {
                        list = this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.boundingBox.expand(6.25, 10.0, 6.25));
    ...
    public boolean interact(final EntityPlayer par1EntityPlayer) {
        ...
        if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.diamond_block) && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 36.0) {
            if (!this.worldObj.isRemote) {
    ...
    private void firecanon(final double x, final double y, final double z) {
        ...
        bf = new BetterFireball(this.worldObj, (EntityLivingBase)this, x - cx + r1, y + 0.25 - (this.posY + yoff) + r2, z - cz + r3);
