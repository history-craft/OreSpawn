...
public class RenderGhostSkelly extends RenderLiving
{
    ...
    public void renderGhostSkelly(final GhostSkelly par1GhostSkelly, final double par2, final double par4, final double par6, final float par8, final float par9) {
