...
public class KingHead extends EntityLiving
{
    ...
    public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)TheKing.class, this.boundingBox.expand(48.0, 32.0, 48.0));
    ...
    public void onUpdate() {
        ...
        if (this.worldObj.isRemote) {
            ...
            final List var5 = this.worldObj.getEntitiesWithinAABB((Class)TheKing.class, this.boundingBox.expand(32.0, 32.0, 32.0));
            final Iterator var6 = var5.iterator();
            Entity var7 = null;
            TheKing var8 = null;
            if (var6.hasNext()) {
