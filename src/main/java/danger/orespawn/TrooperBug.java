    ...
    protected void updateAITasks() {
        ...
        if (this.worldObj.rand.nextInt(5) == 0) {
            ...
            if (e != null) {
                ...
                else if (this.getDistanceSqToEntity((Entity)e) < (5.0f + e.width / 2.0f) * (5.0f + e.width / 2.0f)) {
                    this.setAttacking(1);
                ...
                if (this.worldObj.rand.nextInt(30) == 1) {
                    final EntityCreature newent = (EntityCreature)spawnCreature(this.worldObj, "Spit Bug", (this.posX + e.posX) / 2.0 + this.worldObj.rand.nextInt(5) - this.worldObj.rand.nextInt(5), (this.posY + e.posY) / 2.0 + 1.01, (this.posZ + e.posZ) / 2.0 + this.worldObj.rand.nextInt(5) - this.worldObj.rand.nextInt(5));
                }
            }
            else {
                this.setAttacking(0);
