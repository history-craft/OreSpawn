...
public class RenderCreepingHorror extends RenderLiving
{
    ...
    public void renderCreepingHorror(final CreepingHorror par1EntityCreepingHorror, final double par2, final double par4, final double par6, final float par8, final float par9) {
