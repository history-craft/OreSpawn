...
public class LeafMonster extends EntityMob
{
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(4.0, 6.0, 4.0));
    ...
    private int findBuddies() {
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)LeafMonster.class, this.boundingBox.expand(20.0, 10.0, 20.0));
        return var5.size();
    }
