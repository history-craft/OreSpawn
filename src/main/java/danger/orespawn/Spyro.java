...
public class Spyro extends EntityTameable
{
    ...
    public boolean interact(final EntityPlayer par1EntityPlayer) {
        ...
        if (this.isTamed() && var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.ice) && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 16.0 && this.func_152114_e((EntityLivingBase)par1EntityPlayer)) {
            if (!this.worldObj.isRemote) {
                this.playTameEffect(true);
                this.worldObj.setEntityState((Entity)this, (byte)6);
                this.setSpyroFire(0);
            ...
            if (e != null) {
                if (this.isTamed() && this.getHealth() / this.mygetMaxHealth() < 0.25f) {
                    ...
                    if (this.getDistanceSqToEntity((Entity)e) < (3.0f + e.width / 2.0f) * (3.0f + e.width / 2.0f)) {
                        ...
                        final EntitySmallFireball var2 = new EntitySmallFireball(this.worldObj, (EntityLivingBase)this, e.posX - this.posX, e.posY + 0.25 - (this.posY + 1.25), e.posZ - this.posZ);
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        return this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL && par1EntityLiving != null && par1EntityLiving != this && par1EntityLiving.isEntityAlive() && this.getEntitySenses().canSee((Entity)par1EntityLiving) && !(par1EntityLiving instanceof Spyro) && (par1EntityLiving instanceof Mothra || par1EntityLiving instanceof EntityMob);
    }
