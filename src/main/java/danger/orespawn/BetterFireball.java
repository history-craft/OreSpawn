...
public class BetterFireball extends EntityFireball
{
    ...
    public void onUpdate() {
        ...
        if (!this.worldObj.isRemote && ((this.shootingEntity != null && this.shootingEntity.isDead) || !this.worldObj.blockExists((int)this.posX, (int)this.posY, (int)this.posZ))) {
            ...
            var18 = null;
            var19 = this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.boundingBox.addCoord(this.motionX, this.motionY, this.motionZ).expand(1.0, 1.0, 1.0));
            var20 = 0.0;
            for (int var28 = 0; var28 < var19.size(); ++var28) {
                ...
                if (var21.canBeCollidedWith() && (!var21.isEntityEqual((Entity)this.shootingEntity) || this.ticksInAir >= 25)) {
                    final AxisAlignedBB var29 = var21.boundingBox.expand((double)var22, (double)var22, (double)var22);
