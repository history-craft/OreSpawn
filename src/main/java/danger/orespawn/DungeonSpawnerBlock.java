...
{
    protected DungeonSpawnerBlock(final int par1) {
    ...
    public void randomDisplayTick(final World par1World, final int par2, final int par3, final int par4, final Random par5Random) {
        for (int j1 = 0; j1 < 5; ++j1) {
            par1World.spawnParticle("fireworksSpark", (double)(par2 + par1World.rand.nextFloat()), par3 + (double)par1World.rand.nextFloat(), (double)(par4 + par1World.rand.nextFloat()), (par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 4.0, par1World.rand.nextFloat() / 2.0, (par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 4.0);
        }
    }
