...
public class RenderPitchBlack extends RenderLiving
{
    ...
    public void renderPitchBlack(final PitchBlack par1EntityPitchBlack, final double par2, final double par4, final double par6, final float par8, final float par9) {
