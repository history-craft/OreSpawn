...
public class EnderReaper extends EntityMob
{
    ...
    protected Entity findPlayerToAttack() {
        ...
        final EntityPlayer entityplayer = this.worldObj.getClosestVulnerablePlayerToEntity((Entity)this, 81.0);
    ...
    private boolean shouldAttackPlayer(final EntityPlayer par1EntityPlayer) {
        ...
        return d2 > 1.0 - 0.025 / d0 && par1EntityPlayer.canEntityBeSeen((Entity)this);
    }
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (EnderReaper)this.worldObj.findNearestEntityWithinAABB((Class)EnderReaper.class, this.boundingBox.expand(16.0, 8.0, 16.0), (Entity)this);
        return target == null;
    }
    ...
    static {
        ...
        attackingSpeedBoostModifier = new AttributeModifier(EnderReaper.attackingSpeedBoostModifierUUID, "Attacking speed boost", 6.199999809265137, 0).setSaved(false);
    }
}
