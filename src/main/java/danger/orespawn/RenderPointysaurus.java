...
public class RenderPointysaurus extends RenderLiving
{
    ...
    public void renderPointysaurus(final Pointysaurus par1EntityPointysaurus, final double par2, final double par4, final double par6, final float par8, final float par9) {
