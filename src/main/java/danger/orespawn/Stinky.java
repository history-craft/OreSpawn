...
public class Stinky extends EntityTameable
{
    ...
    private void dropItemFront(final Item index, final int par1) {
        ...
        final EntityItem var3 = new EntityItem(this.worldObj, this.posX - f * Math.sin(Math.toRadians(this.rotationYawHead)), this.posY + 0.9, this.posZ + f * Math.cos(Math.toRadians(this.rotationYawHead)), new ItemStack(index, par1, 0));
    ...
    private void dropItemRear(final Item index, final int par1) {
        ...
        final EntityItem var3 = new EntityItem(this.worldObj, this.posX + f * Math.sin(Math.toRadians(this.rotationYawHead)), this.posY + 0.25, this.posZ - f * Math.cos(Math.toRadians(this.rotationYawHead)), new ItemStack(index, par1, 0));
        this.worldObj.spawnEntityInWorld((Entity)var3);
    }
    ...
    protected void updateAITasks() {
        ...
        if (!this.isSitting()) {
            ...
            if (this.activity == 1 && this.isTamed() && this.getOwner() != null) {
                ...
                if (this.getDistanceSqToEntity((Entity)e2) > 256.0) {
                    this.setActivity(2);
                }
            }
            this.do_movement();
        ...
        if (this.worldObj.rand.nextInt(7) == 1 && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL) {
            ...
            if (e != null) {
                if (this.isTamed() && this.getHealth() / this.mygetMaxHealth() < 0.25f) {
                    ...
                    do_new = 0;
                    if (this.getDistanceSqToEntity((Entity)e) < (3.0f + e.width / 2.0f) * (3.0f + e.width / 2.0f)) {
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        return this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL && par1EntityLiving != null && par1EntityLiving != this && par1EntityLiving.isEntityAlive() && this.getEntitySenses().canSee((Entity)par1EntityLiving) && (par1EntityLiving instanceof Mothra || par1EntityLiving instanceof EntityMob);
    }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(12.0, 6.0, 12.0));
    ...
    private int findBuddies() {
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)Stinky.class, this.boundingBox.expand(20.0, 10.0, 20.0));
        return var5.size();
    }
}
