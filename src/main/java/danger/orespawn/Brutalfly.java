...
public class Brutalfly extends EntityMob
{
    ...
    protected void updateAITasks() {
        ...
        if (this.worldObj.rand.nextInt(6) == 0) {
            ...
            target = (EntityPlayer)this.worldObj.findNearestEntityWithinAABB((Class)EntityPlayer.class, this.boundingBox.expand(30.0, 20.0, 30.0), (Entity)this);
            if (target != null) {
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (Brutalfly)this.worldObj.findNearestEntityWithinAABB((Class)Brutalfly.class, this.boundingBox.expand(64.0, 32.0, 64.0), (Entity)this);
        return target == null;
    }
    ...
    private void dropItemRand(final Item index, final int par1) {
        final EntityItem var3 = new EntityItem(this.worldObj, this.posX + OreSpawnMain.OreSpawnRand.nextInt(8) - OreSpawnMain.OreSpawnRand.nextInt(8), this.posY + 1.0, this.posZ + OreSpawnMain.OreSpawnRand.nextInt(8) - OreSpawnMain.OreSpawnRand.nextInt(8), new ItemStack(index, par1, 0));
    ...
    private void attackWithSomething(final EntityLivingBase par1) {
        ...
        if (this.worldObj.difficultySetting == EnumDifficulty.EASY) {
            final EntitySmallFireball sf = new EntitySmallFireball(this.worldObj, (EntityLivingBase)this, par1.posX - cx, par1.posY + 0.55 - (this.posY + yoff), par1.posZ - cz);
            ...
            if (this.worldObj.rand.nextInt(2) == 0) {
                ...
                final BetterFireball bf = new BetterFireball(this.worldObj, (EntityLivingBase)this, par1.posX - cx, par1.posY + 0.55 - (this.posY + yoff), par1.posZ - cz);
