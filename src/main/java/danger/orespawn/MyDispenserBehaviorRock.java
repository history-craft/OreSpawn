...
final class MyDispenserBehaviorRock extends BehaviorProjectileDispense
{
    public ItemStack dispenseStack(final IBlockSource par1IBlockSource, final ItemStack par2ItemStack) {
        ...
        iprojectile.setThrowableHeading((double)enumfacing.getFrontOffsetX(), (double)(enumfacing.getFrontOffsetY() + 0.1f), (double)enumfacing.getFrontOffsetZ(), this.func_82500_b(), this.func_82498_a());
    ...
    protected IProjectile getProjectileEntity(final World par1World, final IPosition par2IPosition) {
        final EntityThrownRock entityarrow = new EntityThrownRock(par1World, par2IPosition.getX(), par2IPosition.getY(), par2IPosition.getZ());
