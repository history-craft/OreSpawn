...
public class PitchBlack extends EntityMob
{
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue((double)(this.getPitchBlackScale() * OreSpawnMain.PitchBlack_stats.attack));
    }
    ...
    public boolean attackEntityAsMob(final Entity par1Entity) {
        ...
        if (par1Entity != null && par1Entity instanceof EntityDragon) {
            ...
            var5 = DamageSource.setExplosionSource((Explosion)null);
            var5.setExplosion();
            ...
            var4 = par1Entity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), OreSpawnMain.PitchBlack_stats.attack * this.getPitchBlackScale());
    ...
    public boolean getCanSpawnHere() {
        ...
        if (this.worldObj.provider.dimensionId == OreSpawnMain.DimensionID6) {
            ...
            target = (PitchBlack)this.worldObj.findNearestEntityWithinAABB((Class)PitchBlack.class, this.boundingBox.expand(16.0, 16.0, 16.0), (Entity)this);
            if (target != null) {
                return false;
            }
        }
    ...
    private Entity findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(d1, d2, d1));
