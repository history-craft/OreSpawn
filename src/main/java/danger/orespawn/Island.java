...
public class Island extends EntityAnimal
{
    ...
    private void update_island() {
                    ...
                    while (h < tradius) {
                        ...
                        if (ix != ixlast || iz != izlast) {
                            ...
                            if (i == 0) {
                                ...
                                if (bid == Blocks.stone) {
                                    if (!this.worldObj.isRemote) {
                                        this.worldObj.createExplosion((Entity)this, (double)ix, this.posY - i + 1.0, (double)iz, 5.0f, true);
                                    }
                                }
                                else if (this.worldObj.rand.nextInt(10) == 1) {
                                    this.FastSetBlock(ix, (int)this.posY - i + 1, iz, Blocks.diamond_ore);
        ...
        if (this.worldObj.rand.nextInt(2 + 2000 / this.timer) == 1) {
            ...
            final List var5 = this.worldObj.getEntitiesWithinAABB((Class)Triffid.class, bb);
            final Iterator var6 = var5.iterator();
            if (!var6.hasNext()) {
                final EntityCreature newent = (EntityCreature)spawnCreature(this.worldObj, "Triffid", this.posX, this.posY + 2.01, this.posZ);
            }
        }
    }
