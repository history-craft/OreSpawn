...
public class Ostrich extends EntityCannonFodder
{
    ...
    public Ostrich(final World par1World) {
        ...
        this.tasks.addTask(7, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, (Class)EntityLiving.class, 5.0f));
    ...
    public boolean getCanSpawnHere() {
        ...
        Ostrich target = null;
        target = (Ostrich)this.worldObj.findNearestEntityWithinAABB((Class)Ostrich.class, this.boundingBox.expand(16.0, 6.0, 16.0), (Entity)this);
        return target == null;
    }
