...
public class OreCrystalCrystal extends Block
{
    ...
    private void sparkle(final World par1World, final int par2, final int par3, final int par4) {
        ...
        if (this == OreSpawnMain.TigersEye) {
            ...
            par1World.spawnParticle("fireworksSpark", (double)(par2 + dx), par3 + (double)dy, (double)(par4 + dz), (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 4.0f), (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 4.0f), (double)((par1World.rand.nextFloat() - par1World.rand.nextFloat()) / 4.0f));
        }
    }
    ...
    public void onBlockDestroyedByPlayer(final World par1World, final int par2, final int par3, final int par4, final int par5) {
        if (this == OreSpawnMain.CrystalCrystal && !par1World.isRemote && par1World.rand.nextInt(10) == 1) {
            par1World.newExplosion((Entity)null, (double)(par2 + 0.5f), (double)(par3 + 0.5f), (double)(par4 + 0.5f), 1.0f, true, par1World.getGameRules().getGameRuleBooleanValue("mobGriefing"));
        }
