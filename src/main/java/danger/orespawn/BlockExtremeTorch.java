            ...
            if (found != 0) {
                if (!world.isRemote) {
                    ...
                    for (int var3 = 0; var3 < 16; ++var3) {
                        world.spawnParticle("smoke", (double)(par2 + world.rand.nextFloat() - world.rand.nextFloat()), (double)(par3 + world.rand.nextFloat()), (double)(par4 + world.rand.nextFloat() - world.rand.nextFloat()), 0.0, 0.0, 0.0);
                        world.spawnParticle("explode", (double)(par2 + world.rand.nextFloat() - world.rand.nextFloat()), (double)(par3 + world.rand.nextFloat()), (double)(par4 + world.rand.nextFloat() - world.rand.nextFloat()), 0.0, 0.0, 0.0);
                        world.spawnParticle("reddust", (double)(par2 + world.rand.nextFloat() - world.rand.nextFloat()), (double)(par3 + world.rand.nextFloat()), (double)(par4 + world.rand.nextFloat() - world.rand.nextFloat()), 0.0, 0.0, 0.0);
                    }
                }
