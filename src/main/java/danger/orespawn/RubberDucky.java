...
public class RubberDucky extends EntityTameable
{
    ...
    public RubberDucky(final World par1World) {
        ...
        this.tasks.addTask(5, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, (Class)EntityLiving.class, 6.0f));
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(8.0, 4.0, 8.0));
