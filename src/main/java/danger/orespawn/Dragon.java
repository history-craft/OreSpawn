...
public class Dragon extends EntityTameable
{
    ...
    public Dragon(final World par1World) {
        ...
        this.tasks.addTask(4, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, (Class)EntityPlayer.class, 9.0f));
        this.tasks.addTask(5, (EntityAIBase)new EntityAILookIdle((EntityLiving)this));
        this.tasks.addTask(6, (EntityAIBase)new EntityAIMoveIndoors((EntityCreature)this));
        if (OreSpawnMain.PlayNicely == 0) {
            this.targetTasks.addTask(1, (EntityAIBase)new EntityAINearestAttackableTarget((EntityCreature)this, (Class)EntityLiving.class, 0, true, false, IMob.mobSelector));
        }
    ...
    public void always_do() {
        ...
        if (this.isTamed() && this.getOwner() != null && !this.isSitting()) {
            p = (EntityPlayer)this.getOwner();
            if (this.getDistanceSqToEntity((Entity)p) > 400.0) {
                this.setActivity(1);
            }
        }
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        return this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL && par1EntityLiving != null && par1EntityLiving != this && par1EntityLiving.isEntityAlive() && this.getEntitySenses().canSee((Entity)par1EntityLiving) && !(par1EntityLiving instanceof LurkingTerror) && !(par1EntityLiving instanceof EnderReaper) && !(par1EntityLiving instanceof TerribleTerror) && !(par1EntityLiving instanceof LeafMonster) && !(par1EntityLiving instanceof CreepingHorror) && !(par1EntityLiving instanceof Triffid) && (par1EntityLiving instanceof EntityMob || par1EntityLiving instanceof Mothra || par1EntityLiving instanceof Kraken || (par1EntityLiving instanceof EntityPlayer && false));
    }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, this.boundingBox.expand(20.0, 20.0, 20.0));
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (Dragon)this.worldObj.findNearestEntityWithinAABB((Class)Dragon.class, this.boundingBox.expand(16.0, 6.0, 16.0), (Entity)this);
        ...
        if (this.worldObj.isRemote) {
            ...
            if (this.getActivity() != 0) {
                ...
                if (this.riddenByEntity != null) {
                    ...
                    if (this.fireballticker == 0) {
                        ...
                        if (this.getDragonType() == 0) {
                            if (pp.moveStrafing > 0.001f) {
                                bf = new BetterFireball(this.worldObj, (EntityLivingBase)this, 0.0, 0.0, 0.0);
                                bf.setNotMe();
                                bf.setSmall();
                    ...
                    this.motionZ *= 0.985;
                    if (!this.worldObj.isRemote) {
                        list = this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.boundingBox.expand(2.25, 2.0, 2.25));
    ...
    public boolean interact(final EntityPlayer par1EntityPlayer) {
        ...
        if (!this.isTamed()) {
            ...
            if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.ice) && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 25.0 && this.func_152114_e((EntityLivingBase)par1EntityPlayer)) {
                if (!this.worldObj.isRemote) {
                    this.playTameEffect(true);
                    this.worldObj.setEntityState((Entity)this, (byte)6);
