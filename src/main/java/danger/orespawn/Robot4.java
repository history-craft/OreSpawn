    ...
    public void onLivingUpdate() {
        ...
        if (this.worldObj.isRemote) {
            ...
            if (this.getAttacking() != 0) {
                this.worldObj.spawnParticle("reddust", this.posX - 1.55 * Math.sin(Math.toRadians(this.rotationYaw + 35.0f)), this.posY + 2.25 + this.worldObj.rand.nextFloat(), this.posZ + 1.55 * Math.cos(Math.toRadians(this.rotationYaw + 35.0f)), 0.0, (double)this.worldObj.rand.nextFloat(), 0.0);
            }
        }
    }
