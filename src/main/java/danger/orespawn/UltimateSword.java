...
public class UltimateSword extends ItemSword
{
        ...
        if (this == OreSpawnMain.MyChainsaw) {
            ...
            if (par2World.isRemote && this.swingtimer > 0) {
                ...
                if (par2World.rand.nextInt(8) == 0) {
                    par2World.spawnParticle("flame", par3Entity.posX + dx, par3Entity.posY, par3Entity.posZ + dz, (double)((par2World.rand.nextFloat() - par2World.rand.nextFloat()) / 20.0f), (double)(par2World.rand.nextFloat() / 10.0f), (double)((par2World.rand.nextFloat() - par2World.rand.nextFloat()) / 20.0f));
                }
                if (par2World.rand.nextInt(2) == 0) {
                    par2World.spawnParticle("smoke", par3Entity.posX + dx, par3Entity.posY, par3Entity.posZ + dz, (double)((par2World.rand.nextFloat() - par2World.rand.nextFloat()) / 20.0f), (double)(par2World.rand.nextFloat() / 10.0f), (double)((par2World.rand.nextFloat() - par2World.rand.nextFloat()) / 20.0f));
                }
                if (par2World.rand.nextInt(10) == 0) {
                    par2World.spawnParticle("fireworksSpark", par3Entity.posX + dx, par3Entity.posY, par3Entity.posZ + dz, (double)((par2World.rand.nextFloat() - par2World.rand.nextFloat()) / 20.0f), (double)(par2World.rand.nextFloat() / 5.0f), (double)((par2World.rand.nextFloat() - par2World.rand.nextFloat()) / 20.0f));
                }
            }
            return;
        }
    ...
    private void findSomethingToHit(final EntityPlayer player) {
        final List var5 = player.worldObj.getEntitiesWithinAABB((Class)EntityLivingBase.class, player.boundingBox.expand(5.0, 5.0, 5.0));
    ...
    private ItemStack dropItemRand(final World world, final Item index, final int par1, final int x, final int y, final int z) {
        ...
        var3 = new EntityItem(world, (double)(x + OreSpawnMain.OreSpawnRand.nextInt(5) - OreSpawnMain.OreSpawnRand.nextInt(5)), y + 1.0 + world.rand.nextInt(5), (double)(z + OreSpawnMain.OreSpawnRand.nextInt(5) - OreSpawnMain.OreSpawnRand.nextInt(5)), is);
        if (var3 != null) {
