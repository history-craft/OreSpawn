...
public class RenderThePrincess extends RenderLiving
{
    ...
    public void renderThePrincess(final ThePrincess par1EntityThePrincess, final double par2, final double par4, final double par6, final float par8, final float par9) {
