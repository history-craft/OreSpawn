...
public class Leon extends EntityTameable
{
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (Leon)this.worldObj.findNearestEntityWithinAABB((Class)Leon.class, this.boundingBox.expand(48.0, 16.0, 48.0), (Entity)this);
    ...
    public boolean interact(final EntityPlayer par1EntityPlayer) {
        ...
        if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.diamond_block) && par1EntityPlayer.getDistanceSqToEntity((Entity)this) < 49.0) {
            if (!this.worldObj.isRemote) {
                this.setTamed(true);
